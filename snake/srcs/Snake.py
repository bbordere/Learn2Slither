...
import pygame as pg
from config import GRID_HEIGHT, GRID_WIDTH, START_LEN
from srcs.SpriteManager import SpriteManager
from srcs.utils import Direction, Pos, convert_pos, opposite
...
class Snake:
    ...
    def draw(self, screen: pg.surface, sprite_manager: SpriteManager):
        """Draws the snake on the given screen using the
            provided sprite manager.
