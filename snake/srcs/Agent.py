...
from srcs.utils import Direction
...
class TableAgent(BaseAgent):
    ...
    def choose_best_action(self, state: np.ndarray) -> Direction:
        """This function chooses the best action for a given state
            by finding the maximum value in that row of the Q-table.
...
def boltzmann_action_selection(q_values: np.ndarray, temp: float) -> int:
